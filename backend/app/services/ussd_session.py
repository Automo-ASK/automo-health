...
_MAIN_MENU: dict[str, dict[str, str]] = {
    "en":     {"1": "Book appointment", "2": "Reschedule", "3": "Cancel"},
    "pidgin": {"1": "Book appointment", "2": "Change appointment", "3": "Cancel appointment"},
    "yo":     {"1": "Ṣe adehun", "2": "Yi adehun pada", "3": "Fagilé adehun"},
}
...
_STUB_COMING_SOON: dict[str, str] = {
    ...
    "yo":     "Ẹya yii n bọ laipẹ. Jọwọ pe ile-iwosan.",
}
...
def handle(_session_id: str, _phone: str, text: str) -> USSDResult:
    ...
    if len(steps) == 1:
        ...
        greet = {"en": "What would you like to do?", "pidgin": "Wetin you wan do?", "yo": "Kini o fẹ ṣe?"}
        return USSDResult(f"CON {greet[lang]}\n{lines}")

    action_key = steps[1]
    if action_key not in ("1", "2", "3"):
        return USSDResult("END Invalid option. Please dial again.")

    # Reschedule / cancel — stub until Day 5
